                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/employee/register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="middle_name" value="{{ old('first_name') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('primary_phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="primary_phone" type="text" class="form-control" name="primary_phone" value="{{ old('primary_phone') }}">
                        ...
                        <div class="form-group{{ $errors->has('secondary_phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="secondary_phone" type="text" class="form-control" name="secondary_phone" value="{{ old('secondary_phone') }}">
